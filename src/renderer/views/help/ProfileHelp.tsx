...
const ProfileHelp: SFC = () => (
  <Help>
    ...
    <Accordion trigger="I don't see my organization">
      <p>
        Depending on your organization settings, you may have to enable access.{' '}
        ...
        and scroll down to <em>Organization Settings</em> on the bottom of the left column. Make sure that that you grant access to
        whichever organizations that you want to use within Trax.
      </p>
    </Accordion>
  </Help>
)
